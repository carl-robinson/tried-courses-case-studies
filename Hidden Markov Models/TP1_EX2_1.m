...
% generate empirical
% 0:non-pluie, 1:pluie
[sequence,etats] = mccgenerate(T,A,B,'Symbols',[0,1],'Statenames',[0,1,2]); 
...
title('PDF of Real & Empirical data - RAINY DAYS', 'FontSize', 18);
...
title('PDF of Real Data and Empirical - DRY DAYS', 'FontSize', 18);
...
% 0:non-pluie, 1:pluie
[sequence_est,etats_est] = mccgenerate(T,A_est,B_est,'Symbols',[0,1],'Statenames',[0,1,2]); 
...
title('PDF of Real & NEW Empirical data - RAINY DAYS', 'FontSize', 18);
xlabel('Duration of consecutive Rain Days (Days)', 'FontSize', 16);
ylabel('PDF (semilog scale)', 'FontSize', 16);
grid on;
...
title('PDF of Real & NEW Empirical data - DRY DAYS', 'FontSize', 18);
xlabel('Duration of consecutive Dry Days (Days)', 'FontSize', 16);
ylabel('PDF (semilog scale)', 'FontSize', 16);
grid on;
legend('Real Data','NEW Empirical')
